...
export const Link = forwardRef<HTMLAnchorElement, BaseLinkProps>(({ children, className, variant, hidden, ...props }, ref) => {
  ...
  useEffect(() => {
    if (props.prefetch === false || hidden) {
      return;
    }
