...
import { LucideChevronRight as ChevronRight } from "lucide-react";
...
const RefBox2 = React.forwardRef<HTMLInputElement, InputProps>(
  ({ id = "Refbox", value, className, suggestWords, suggestBoxWidth = 0.5, ...props }, ref) => {
    ...
    function SuggestBox({
      ...
      const vw = (x / window.innerWidth) * 100; //viewport distance from full screen right
